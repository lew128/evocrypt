...
class KnuthNewLib() :
    ...
    def next( self, bit_width, cycles ) :
        ...
        left_shift_width = int( bit_width / ( cycles * self.paranoia_level)) + 1
        while return_value < ( 1 << bit_width * 2 ) :
            for _ in range( cycles * self.paranoia_level ) :
...
class MultiplyAdd03( MultiplyAdd02 ) :
    ...
    def __init__( self, rnt, integer_width, n_integers, paranoia_level,
        ...
        increment = rnt.randint( 48 ) / n_integers
...
#            print( hex( THE_RANDOM_NUMBER ) )
    ...
    if 'search' in TEST_LIST :
        ...
        while True :
            ...
            if BIG_PRIME & 0x0F :      # one of 16 produces flawed ints
